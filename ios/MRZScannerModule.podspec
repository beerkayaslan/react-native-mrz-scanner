...
Pod::Spec.new do |s|
  ...
  s.homepage       = 'https://github.com/berkayaslan/react-native-mrz-scanner'
  s.license        = 'MIT'
  s.author         = 'berkayaslan'
  s.source         = { :git => 'https://github.com/berkayaslan/react-native-mrz-scanner.git', :tag => s.version.to_s }
