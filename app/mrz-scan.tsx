...
import { scanMRZ } from "../modules/mrz-scanner";
    ...
    const startNativeMRZScan = useCallback(async () => {
        ...
        try {
            ...
            if (result) {
                ...
                Alert.alert("Hata", "MRZ metni ayrıştırılamadı. Lütfen tekrar deneyin.");
            }
        } catch (error: any) {
            ...
            {!parsedData ? (
                <View style={styles.scanContainer}>
                    <View style={styles.infoBox}>
                        ...
                        <Text style={styles.infoText}>
                            Lütfen kimliğin arka tarafını kameraya okutunuz. MRZ alanı otomatik olarak
                            tanınacaktır.
                        </Text>
                    </View>
                    ...
                    <View style={styles.actions}>
                        ...
                        >
                            <Text style={[styles.buttonText, styles.secondaryText]}>⌨️ Manuel Giriş</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            ) : (
                <View style={styles.resultContainer}>
                    ...
                    <View style={styles.card}>
                        ...
                        <InfoRow label="Doğum Tarihi" value={formatDate(parsedData.dateOfBirth)} />
                        <InfoRow label="Son Geçerlilik" value={formatDate(parsedData.expiryDate)} />
                    ...
                    <TouchableOpacity style={[styles.button, styles.secondaryButton]} onPress={resetScan}>
                        <Text style={[styles.buttonText, styles.secondaryText]}>Tekrar Tara</Text>
                    </TouchableOpacity>
                </View>
            )}
        </View>
